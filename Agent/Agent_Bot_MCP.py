...
from tools import firewall, memory, network, process, systemd, systemd_mcp
...
async def main():
    ...
    network_subagent = {
        ...
        "description": "Used to determine which application uses a specific network port",
    ...
    memory_subagent = {
        ...
        "description": "Used to check overall memory consumption on a Linux system",
    ...
    systemd_mcp_tools = await systemd_mcp.systemd_mcp_tools()
#    print(f"{systemd_mcp_tools}")
    systemd_subagent = {
